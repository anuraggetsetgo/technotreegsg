...
export default function Dashboard(props) {
    ...
    const lastProgressImg = userData.clientProgress.length > 0 ? userData.clientProgress[0].pic_1 : null;
    const firstProgressImg = userData.clientProgress.length > 0 ? userData.clientProgress[userData.clientProgress.length - 1].pic_1 : null;
    return (<>
