...
import { cmtoinch, cmtoft,  kgtolb, fttocm } from '../../Utils/Services'
        ...
        switch (obj.type) {
            case 'height':
                if (obj.unit === 'ft') {
                    ...
                    setUserData_API({ ...userData_API, [obj.name]: fttocm(obj.value), [obj.name + '_in']: cmtoinch(fttocm(obj.value)), [obj.name + '_ft']: obj.value })//passing in inch
                }
                if (obj.unit === 'cm') {
                    setUserData({ ...userData, [obj.name]: (obj.value) });
                            ...
                            {section === 3 &&
                                (<Grid item container style={Styles.marginTop16} direction='column' alignItems='center' justify='center' spacing={4} >
                                    ...
                                    <Grid container direction="column" alignItems='center' justify='center' style={Styles.questionHeight}>
                                        ...
                                        <Grid container item style={{ display: 'block', overflow: 'hidden' }} direction='column' align='center' justify='center'>
                            ...
                            {section === 5 &&
                                (<Grid item container style={Styles.marginTop16} direction='column' alignItems='center' justify='center' spacing={4} >
                                    ...
                                    <Grid container direction="column" alignItems='center' justify='center' style={Styles.questionHeight}>
                                        ...
                                        {unit === 1 && (<Grid container item style={{ display: 'block', overflow: 'hidden' }} initialPosition={userData.weight} direction='column' align='center' justify='center'>
